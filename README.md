...
- `goals.md` — mastery target and metacognition gates
- `concept-graph.md` — DAG: nodes, prereqs, edges
...
The gap identified in diagnosis: the learner understands absolute value inequality *structure* (V-shape, interior region) but loses precision in execution. Node 02 is the direct remediation. Nodes 05–07 are the payoff: quadratics require all prior fluency to be automatic so working memory is free for the harder reasoning.
